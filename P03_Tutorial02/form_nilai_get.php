...
<body>
    ...
    <main role="main" class="container mt-3">
        ...
        <form class="mx-auto" action="" method="">
            <div class="form-group row">
                ...
                <div class="col-7">
                    <input name="nama" id="nama" placeholder="Nama Lengkap" type="text" required="required" class="form-control">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-7">
                    <input name="nilai_uts" id="nilai_uts" placeholder="Nilai UTS" type="number" class="form-control" required="required" min="0" max="100">
                </div>
            </div>
            <div class="form-group row">
                <label for="nilai_uas" class="col-5 col-form-label font-weight-bold text-right">Nilai UAS</label>
                <div class="col-7">
                    <input name="nilai_uas" id="nilai_uas" placeholder="Nilai UAS" type="number" class="form-control" required="required" min="0" max="100">
                </div>
            </div>
            <div class="form-group row">
                <label for="nilai_tugas" class="col-5 col-form-label font-weight-bold text-right">Nilai Tugas/Praktikum</label>
                <div class="col-7">
                    <input name="nilai_tugas" id="nilai_tugas" placeholder="Nilai Tugas" type="number" class="form-control" required="required" min="0" max="100">
                </div>
            </div>
            <div class="form-group row">
    ...
    <?php
        $proses = isset($_GET['proses']) ? $_GET['proses'] : "Kosong";
        $nama = isset($_GET['nama']) ? $_GET['nama'] : "Kosong";
        $matkul = isset($_GET['matkul']) ? $_GET['matkul'] : "Kosong";
        $nilai_uts = isset($_GET['nilai_uts']) ? $_GET['nilai_uts'] : "Kosong";
        $nilai_uas = isset($_GET['nilai_uas']) ? $_GET['nilai_uas'] : "Kosong";
        $nilai_tugas = isset($_GET['nilai_tugas']) ? $_GET['nilai_tugas'] : "Kosong";
        // $nilai_akhir = ($nilai_uts !== "Kosong" && $nilai_uas !== "Kosong" && $nilai_tugas !== "Kosong") ? ($nilai_uts + $nilai_uas + $nilai_tugas) / 3 : "Kosong";
    ...
    <footer class="mt-5" style="bottom: 0; left: 0; right: 0; position: fixed;">
        <nav class="navbar navbar-expand-md navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand" href="#">Develop By @ahusa &copy;<?php echo date("Y"); ?></a>
            </div>
        </nav>
    </footer>
